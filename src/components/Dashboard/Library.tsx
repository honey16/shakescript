...
//       // Episode title
//       doc.setFontSize(16);
//       doc.text(`Episode ${episode.episode_number}: ${episode.episode_title}`, 20, yPosition);
//       yPosition += lineHeight;

//       // Episode content
//       doc.setFontSize(12);
//       const contentLines = doc.splitTextToSize(episode.episode_content, 170);
...
//                 <h1 className="text-4xl font-bold text-zinc-100">{selectedStory.title}</h1>
